...
class TestFusionBobCatalogListSpec extends AnyFunSuite {
  test("Bob can read his own catalog bucket") {
    ...
    println("Listing objects in altastata-myorgrsa444-catalog-bob123 with prefix 'Public/' with java sdk...")
    val files = manager.listObjects("altastata-myorgrsa444-catalog-bob123", "Public/", false)
