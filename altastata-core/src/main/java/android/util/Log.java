...
/*
 	AltaStata implementation in case we run android implementation for desktop application
 */
...
public final class Log {
    ...
    /**
     * Private constructor to prevent instantiation of the Log utility class.
     */
    private Log() {
    }
    /**
